...
export default function ProductGrid() {
  return (
    ...
    <section className="mx-auto max-w-7xl px-4 py-8">
      ...
      {/* 상품 그리드 */}
      <div className="lg:grid-cols-4 md:grid-cols-3 grid grid-cols-2 gap-4">
        {products.map((product) => (
          <div
            key={product.id}
            className="overflow-hidden border rounded-lg transition-shadow hover:shadow-md duration-300"
          >
