...
export default function DarkModeManualControl() {
    const blogPosts = [
        {
            title: "첫 번째 블로그 포스트",
        ...
        <main className="mx-auto px-4 py-8 dark:bg-gray-900">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                {blogPosts.map((post, index) => (
                    <div
                        key={index}
                        className="overflow-hidden rounded-lg bg-white shadow-lg transition-shadow duration-300 hover:shadow-xl dark:bg-gray-800 dark:text-white"
                    >
                        <Image
                            width={500}
                            height={500}
